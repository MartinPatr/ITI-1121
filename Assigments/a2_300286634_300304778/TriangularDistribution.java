...
public class TriangularDistribution {
	...
	public Rational pdf(int x) {
		if (x < this.a){
			...
			return new Rational(2*(x-this.a),(this.b - this.a)*(this.c - this.a));
		}
		else if (this.c == x){
			return new Rational(2,(this.b - this.a));
		}
		else if (this.c < x && x <= this.b){
			return new Rational(2*(this.b-x),(this.b - this.a)*(this.b - this.c));
		}
		else{
			return new Rational(0,1);
		}
